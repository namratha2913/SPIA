...
signaling pathway data for several popular organisms. SPIA 
...
website on: 10/17/2011. For a list of changes in SPIA compared 
...
5) The date stamp for KEGG's pathway  data is 10/17/2011.
